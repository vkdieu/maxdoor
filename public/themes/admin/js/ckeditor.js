...
(function() {
  ...
  CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
    ...
    return {
      ...
      on: function(b, d, g, k, h) {
        ...
        function r() { B.removeListener(b, d) } var f = a.call(this, b); if (0 > f.getListenerIndex(d)) { f = f.listeners;
          g || (g = this);
          isNaN(h) && (h = 10); var B = this;
          p.fn = d;
          p.priority = h; for (var u = f.length - 1; 0 <= u; u--)
            if (f[u].priority <= h) return f.splice(u + 1, 0, p), { removeListener: r };
          f.unshift(p) } return { removeListener: r } },
      ...
      removeListener: function(a, b) { var g = d(this)[a]; if (g) { var k = g.getListenerIndex(b);
  ...
  (function() {
    ...
    CKEDITOR.tools = {
      ...
      extend: function(a) { var f = arguments.length,
          b, c; "boolean" == typeof(b = arguments[f - 1]) ? f-- : "boolean" == typeof(b = arguments[f - 2]) && (c = arguments[f - 1], f -= 2); for (var h = 1; h < f; h++) { var d = arguments[h],
            m; for (m in d)
            if (!0 === b || null == a[m])
      ...
      transformPlainTextToHtml: function(a, f) {
        ...
        if (!b) { var d = /\n{2}/g; if (d.test(c)) var m = "\x3c" + h + "\x3e",
            p = "\x3c/" + h + "\x3e",
      ...
      normalizeCssText: function(a, f) { var b = [],
          c, h = CKEDITOR.tools.parseCssText(a, !0, f); for (c in h) b.push(c + ":" + h[c]);
      ...
      normalizeHex: function(a) { return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(a, b, c, h) { a = b.toLowerCase();
          3 == a.length && (a = a.split(""), a = [a[0], a[0], a[1], a[1], a[2], a[2]].join("")); return "#" + a + h }) },
      ...
      writeCssText: function(a, b) { var c, h = []; for (c in a) h.push(c + ":" + a[c]);
        b && h.sort(); return h.join("; ") },
      objectCompare: function(a, b, c) { var h; if (!a && !b) return !0; if (!a || !b) return !1; for (h in a)
          if (a[h] != b[h]) return !1;
        if (!c)
          for (h in b)
            if (a[h] != b[h]) return !1;
      ...
      eventsBuffer: function(a, b, c) {
        function h() { p = (new Date).getTime();
          d = !1;
          c ? b.call(c) : b() } var d, p = 0; return { input: function() { if (!d) { var b = (new Date).getTime() - p;
      ...
      checkIfAnyArrayItemMatches: function(a, b) { for (var c = 0, h = a.length; c < h; ++c)
        ...
        parse: {
          ...
          margin: function(a) {
            function b(a) { c.top = h[a[0]];
              ...
              c.bottom = h[a[2]];
              c.left = h[a[3]] } var c = {},
              h = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"]; switch (h.length) {
              case 1:
                b([0, 0, 0, 0]); break;
              case 2:
                b([0, 1, 0, 1]); break;
      ...
      array: {
        filter: function(a, b, c) { var h = [];
          this.forEach(a, function(d, p) { b.call(c, d, p, a) && h.push(d) }); return h },
        forEach: function(a, b, c) { var h = a.length,
            d; for (d = 0; d < h; d++) b.call(c, a[d], d, a) },
        map: function(a, b, c) {
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
    ...
    getByAddress: function(a, d) {
      for (var b =
          ...
          for (var g = -1, k = 0; k < b.childNodes.length; k++) { var h = b.childNodes[k]; if (!0 !== d || 3 != h.nodeType || !h.previousSibling || 3 != h.previousSibling.nodeType)
              if (g++, g == e) { b = h; break } } else b = b.childNodes[e] }
  ...
  (function() {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      mergeSiblings: function() {
        function a(b, c, f) {
          if (c && c.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (b.isIdentical(c)) { for (var h = f ? b.getLast() : b.getFirst(); d.length;) d.shift().move(b, !f);
              c.moveChildren(b, !f);
              c.remove();
      ...
      getDocumentPosition: function(a) {
        ...
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
          ...
          for (m = this, x = null; m && "body" != m.getName() &&
            ...
            m.equals(this) || (b += m.$.clientLeft || 0, c += m.$.clientTop || 0); for (; x && !x.equals(m);) b -= x.$.scrollLeft, c -= x.$.scrollTop, x = x.getParent();
            x = m;
      ...
      scrollIntoParent: function(a, b, c) {
        ...
        function m(a, b) { var c = { x: 0, y: 0 }; if (!a.is(k ? "body" : "html")) { var f = a.$.getBoundingClientRect();
            c.x = f.left;
            c.y = f.top }
          f = a.getWindow();
          f.equals(b) || (f = m(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y); return c }
  ...
  (function() {
    function a(a, b) {
      ...
      if (a && !this._.guardRTL) { var C = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
    ...
    var f = CKEDITOR.dom.walker.empty(),
      B = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function(a) { var b = {},
    ...
    CKEDITOR.dom.element.prototype.getBogus = function() { var a = this;
      do a = a.getPreviousSourceNode(); while (p(a)); return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && e.test(a.getText())) ? a : !1 }
  })();
  ...
  (function() {
    ...
    function d(a, b, c, d, e) {
      function m(a, b, c, f) { var d = c ? a.getPrevious() : a.getNext(); if (f && k) return d;
        l || f ? b.append(a.clone(!0, e), c) : (a.remove(), r && b.append(a)); return d }
      ...
      if (l && n.type == CKEDITOR.NODE_TEXT && q.equals(n)) q = a.document.createText(q.substring(t, A)), c.append(q);
        ...
        for (var P = q.getParents(), v = n.getParents(), G = g(), E = P.length - 1, I = v.length - 1, K = c, L, Z, X, fa = -1, S = G; S <= E; S++) {
          Z =
            P[S];
          X = Z.getNext();
          for (S != E || Z.equals(v[S]) && E < I ? b && (L = K.append(Z.clone(0, e))) : C ? m(Z, K, !1, M) : p && K.append(a.document.createText(Z.substring(t))); X;) { if (X.equals(v[S])) { fa = S; break }
            X = m(X, K) }
          K = L
        }
        K = c;
        for (S = G; S <= I; S++)
          ...
          else { S != I || c.equals(P[S]) && I < E ? b && (L = K.append(c.clone(0, e))) : D ? m(c, K, !1, H) : Q && K.append(a.document.createText(c.substring(0, A))); if (S > fa)
              for (; X;) X = m(X, K, !0);
            K = L }
        l || h()
      }
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            var m = function(a, b) {
              ...
              for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; f =
                ...
                C = f != a ? f.getText() : f.substring(b); if (d.test(C)) return !1 }
              return !0
            };
            ...
            for (l = c(l); l || q;) {
              ...
              for (; q;)
                if (A = !1, q.type == CKEDITOR.NODE_COMMENT) q = q.getPrevious();
                  ...
                  if (q) { A = q.getPrevious(); if (!l && !A) { l = q;
                      q = null; break }
                    q = A } else l = null
                }
              l && (l = c(l.getParent()))
            ...
            for (; l ||
              q;) {
              if (l && !q) {!n && l.equals(g) && (n = !0); if (e ? l.isBlockBoundary() : !h.contains(l)) break;
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
              l = new CKEDITOR.dom.walker(l); var E = CKEDITOR.dom.walker.whitespaces(),
                I = CKEDITOR.dom.walker.bookmark();
              l.evaluator = function(a) { return !E(a) && !I(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break }
            l = this.clone();
            l.collapse();
        ...
        for (this._.nextNode = null; x;) {
          ...
          if (F) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (F = 0);
            ...
            if (CKEDITOR.dtd.$block[q] && "false" == x.getAttribute("contenteditable")) { d = x;
              b(this, a, d); break } else if (x.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { if ("br" == q) F = 1;
              else if (!k && !x.getChildCount() && "hr" != q) { d = x;
                u = x.equals(m); break }
              k && (k.setEndAt(x, CKEDITOR.POSITION_BEFORE_START), "br" != q && (this._.nextNode = x));
              J = 1 } else { if (x.getFirst()) { k || (k = this.range.clone(), k.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
                x = x.getFirst(); continue }
              F = 1 }
          }
          F && !k && (k = this.range.clone(), k.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
          u = (!J || F) && x.equals(m);
          if (k && !J)
            for (; !x.getNext(h) && !u;) { q = x.getParent(); if (q.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { J = 1;
                F = 0;
                u || q.equals(m);
  ...
  (function() {
    function a(a, b, c, d, l) {
      ...
      for (d = a.length; c < d; ++c) {
        ...
        for (t in P) { f = P[t];
          g = n[f];
          E = [];
          v = void 0; for (v in g) - 1 < v.indexOf("*") ? E.push(new RegExp("^" + v.replace(/\*/g, ".*") + "$")) : E.push(v);
          g = E;
          g.length && (n[f] = g, m = !1) }
        n.nothingRequired = m;
    ...
    function c(a, b, c) { if (!a.match || a.match(b)) { if (a.noProperties) return !1;
        ...
        a = a.classes;
        b = b.classes; if (a) { for (var d = !1, l = !0 === a, q = b.length; q--;)
    ...
    function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = H(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {},
        d = 0,
        l; for (l in a) c[l] = a[l], d++; return d ? c : !1 }
    ...
    function p(a, b) { if (!b) return !0; for (var c = 0, d; c < b.length; ++c)
    ...
    function f(a) { var b, c, d, l, e = {},
        q = 1; for (a = H(a); b = a.match(v);)(c = b[2]) ? (d = B(c, "styles"), l = B(c, "attrs"), c = B(c, "classes")) : d = l = c = null, e["$" + q++] = { elements: b[1], classes: c, styles: d, attributes: l }, a = a.slice(b[0].length); return e }
    ...
    function z(a, b, l, e) {
      ...
      if (e.doCallbacks && a.elementCallbacks) { a: { f = a.elementCallbacks; for (var t = 0, g = f.length, v; t < g; ++t)
          ...
          f = void 0 } if (f) return f }
      if (e.doTransform && (f = a._.transformations[b.name])) { u(b); for (t = 0; t < f.length; ++t) q(a, b, f[t]);
        m(b) }
      if (e.doFilter) {
        a: {
          ...
          if (a || f) { u(b); if (t)
            ...
            if (g)
              for (k = 0, C = g.length; k < C; ++k) c(g[k], b, A); if (a)
              for (k = 0, C = a.length; k < C; ++k) d(a[k], b, A, v); if (f)
        ...
        if (!a.allStyles || a.hadInvalidStyle) { for (G in M) a.allStyles || h[G] ? p.push(G + ":" + M[G]) : k = !0;
          p.length && (t.style = p.sort().join("; ")) } else K && (t.style = K);
        if (!a.allClasses ||
          a.hadInvalidClass) { for (G = 0; G < g.length; ++G)(a.allClasses || f[g[G]]) && A.push(g[G]);
    ...
    CKEDITOR.filter.prototype = {
      ...
      addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
            l; for (b = 0; b < a.length && !l; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (l = c); if (l) { for (b = 0; b < a.length; ++b) d.push(t(a[b], l));
  ...
  (function() {
    ...
    CKEDITOR.focusManager.prototype = {
      ...
      blur: function(a) {
        function d() { var a = this._.editor;
      ...
      add: function(a, d) { var b = a.getCustomData("focusmanager"); if (!b || b != this) { b && b.remove(a); var b = "focus",
            c = "blur";
          d && (CKEDITOR.env.ie ? (b = "focusin", c = "focusout") : CKEDITOR.event.useCapture = 1); var e = { blur: function() { a.equals(this.currentActive) && this.blur() }, focus: function() { this.focus(a) } };
          a.on(b, e.focus, this);
          a.on(c, e.blur, this);
  ...
  CKEDITOR.scriptLoader = function() {
    ...
    return {
      ...
      queue: function() {
        function a() { var b;
          (b = c[0]) && this.load(b.scriptUrl, b.callback, CKEDITOR, 0) } var c = []; return function(d, g) { var k = this;
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    load: function(a, d, b) {
      ...
      CKEDITOR.scriptLoader.load(g, function(a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)
          for (var g = k[a[f]], m = 0; m < g.length; m++) { var x = g[m];
            h[x] = this.get(x);
            c[x] = 1 }
        d.call(b, h) }, this)
    }
      ...
      var g = {},
        k = function(b) {
          a.call(this, b, function(a) {
            ...
            var b = [],
              f;
            for (f in a) { var h = a[f],
                u = h && h.requires; if (!d[f]) { if (h.icons)
            ...
            if (b.length) k.call(this,
              b);
            else { for (f in g) h = g[f], h.onLoad && !h.onLoad._called && (!1 === h.onLoad() && delete g[f], h.onLoad._called = 1);
              c && c.call(e || window, g) }
          }, this)
        };
      k.call(this, b)
  ...
  (function() {
      ...
      CKEDITOR.plugins.load(c.split(","), function(c) {
        ...
        CKEDITOR.scriptLoader.load(e, function() {
          for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++)
            for (var q =
                0; q < d.length; q++) { var n = d[q];
              0 === e && l[q] && n.lang && n.langEntries && (a.lang[n.name] = n.langEntries[l[q]]); if (n[c[e]]) n[c[e]](a) }
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      ...
      getSelectedHtml: function(a) {
        ...
        for (var d = new CKEDITOR.dom.documentFragment, e, l, q, n = 0; n < c.length; n++) { var f = c[n],
            g = f.startContainer;
    ...
    CKEDITOR.htmlParser.prototype = {
      ...
      parse: function(b) {
        for (var c, e, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
          ...
          if (k) k.push(c[0]);
          else if (e = c[3]) { if (e = e.toLowerCase(), !/="/.test(e)) { var h = {},
                p, r = c[4];
              c = !!c[5]; if (r)
                for (; p = a.exec(r);) { var f = p[1].toLowerCase();
                  p = p[2] || p[3] || p[4] || "";
  ...
  (function() {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml =
      function(g, k, h) {
        function p(a) { var b; if (0 < x.length)
        ...
        function B(b, c, d) { c = c || w || m; var e = w;
        ...
        y.onText = function(a) { if (!(w._.hasInlineStarted && !J.length || l || F) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = w.name,
            f = b ? CKEDITOR.dtd[b] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!F && !f["#"] && b in d) y.onTagOpen(e[b] || ""), y.onText(a);
          else { r();
            p();
            l || F || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
            a = new CKEDITOR.htmlParser.text(a); if (u(w, a)) this.onTagOpen(h, {}, 0, 1);
            w.add(a) } };
        y.onCDATA =
  ...
  (function() {
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        onElement: function(a, c) { for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], g, k = 0; 3 > k; k++)
    ...
    a.prototype = {
      ...
      addMany: function(a,
        c, d) { for (var g = [this.findIndex(c), 0], k = 0, h = a.length; k < h; k++) g.push({ value: a[k], priority: c, options: d });
      ...
      exec: function(a, c) {
        ...
        for (B = 0; B < h; B++)
          if (d && (p = c.type, r = c.name), f = k[B], !(a.nonEditable && !f.options.applyToAll ||
              a.nestedEditable && f.options.excludeNestedEditable)) { f = f.value.apply(null, g); if (!1 === f || d && f && (f.name != r || f.type != p)) return f;
            null != f && (g[0] = c = f) }
        return c
      },
  ...
  (function() {
    ...
    function p(a) { a = a.attributes; switch (a["data-cke-editable"]) {
        case "true":
    ...
    CKEDITOR.htmlDataProcessor.prototype = {
      ...
      toDataFormat: function(a, b) { var c, d, l;
        b && (c = b.context, d = b.filter, l = b.enterMode);
        c || null === c || (c = this.editor.editable().getName()); return this.editor.fire("toDataFormat", { dataValue: a, filter: d || this.editor.filter, context: c, enterMode: l || this.editor.enterMode }).dataValue }
    };
    var x = /(?:&nbsp;|\xa0)$/,
      J = "{cke_protected}",
      w = CKEDITOR.dtd,
  ...
  (function() {
    ...
    CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
      ...
      filter: function(a, b) {
        ...
        for (;;) { k = d.name; if (!(h = a.onElementName(b, k))) return this.remove(), !1;
          d.name = h; if (!(d = a.onElement(b, d))) return this.remove(), !1; if (d !== this) return this.replaceWith(d), !1; if (d.name == k) break; if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if (!d.name) return this.replaceWithChildren(), !1 }
        k = d.attributes;
        var p, r;
        for (p in k) {
          for (h = k[p];;)
      ...
      writeHtml: function(a, b) { b && this.filter(b); var g = this.name,
          ...
          h = this.attributes,
          p, r;
        a.openTag(g, h); for (p in h) k.push([p, h[p]]);
        a.sortAttributes && k.sort(d);
        p = 0; for (r = k.length; p < r; p++) h = k[p], a.attribute(h[0], h[1]);
        ...
        fixInitialSelection: function() {
          function a() { var b = c.getDocument().$,
            ...
            a: if (d.anchorNode && d.anchorNode == c.$) l = !0;
              else { if (CKEDITOR.env.webkit && (l = c.getDocument().getActive()) && l.equals(c) && !d.anchorNode) { l = !0; break a }
                l = void 0 }
    ...
    m = function() {
      ...
      return function(m, v, G, E) {
        ...
        if (!E.checkReadOnly()) {
          ...
          if (!v.collapsed) { var I = L.block || L.blockLimit,
          ...
          if (H = G) {
            ...
            if ("text" == m.type && m.inlineStylesRoot) { u = m.inlineStylesPeak;
              v = u.getDocument().createText("{cke-peak}"); for (E = m.inlineStylesRoot.getParent(); !u.equals(E);) v = v.appendTo(u.clone()), u = u.getParent();
              G = v.getOuterHtml().split("{cke-peak}").join(G) }
            u =
              m.blockLimit.getName();
            if (/^\s+|\s+$/.test(G) && "span" in CKEDITOR.dtd[u]) { var z = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
              G = z + G + z }
          ...
          if (H) {
            ...
            for (D(v, w); E < v.length; E++) {
              ...
              if (y) G = 0 < E;
                ...
                if ((y = w.startPath().block) && !y.equals(N)) { if (O = y.getBogus()) O.remove(), z.push(y);
                  N = y }
                L.firstNotAllowed && (I = 1);
                if (I && L.isElement) {
                  y = w.startContainer;
                  for (F = null; y && !p[y.getName()][L.name];) { if (y.equals(u)) { y = null; break }
                    F = y;
                    y = y.getParent() }
          ...
          if (!m.dontMoveCaret) {
            for (N = e(O); N && a(N) && !N.is(p.$empty);) {
              ...
              else { if (f(N) && N.getHtml().match(/(\s|&nbsp;)$/g)) { T = null; break }
                T = O.clone();
      ...
      tree: {
        rebuild: function(a, b) {
          ...
          if (e.blockLimit.is({
            ...
            g = function(a) { return !a.equals(k) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) { var h = e.contains(CKEDITOR.dtd.$list).getParent();
      ...
      return {
        list: {
          ...
          merge: function(a, c) { if (a.mergeListBookmark) { var d = a.mergeListBookmark.startNode,
                ...
                l = new CKEDITOR.dom.elementPath(e, c); if (a.mergeList) { var g = f.contains(CKEDITOR.dtd.$list),
        ...
        table: function() {
          function a(c) {
            ...
            l.guard = function(a, l) {
              if (a.type == CKEDITOR.NODE_ELEMENT) { var h = "visited_" + (l ? "out" : "in"); if (a.getCustomData(h)) return;
  ...
  (function() {
    ...
    function g(a) { k(a, !1); var b = a.getDocument().createText(z);
    ...
    CKEDITOR.on("instanceCreated", function(b) {
      ...
      e.on("contentDom", function() {
        ...
        function c() { l.removeListener("mouseup", c);
          q.removeListener("mouseup", c); var a = CKEDITOR.document.$.selection,
          ...
          if ("BackCompat" != f.$.compatMode) {
            if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
              ...
              q.on("mousedown", function(a) {
                function b(a) { a = a.data.$; if (E) { var c = h.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) {}
                ...
                a = a.data;
                if (a.getTarget().is("html") && a.$.y < q.$.clientHeight && a.$.x < q.$.clientWidth) { E = h.$.createTextRange(); try { E.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                  I = E.duplicate();
                  q.on("mousemove", b);
                  l.on("mouseup", c);
                  q.on("mouseup", c) }
    ...
    CKEDITOR.dom.selection.prototype = {
      ...
      getType: B ? function() {
        ...
        return a.type = b
          ...
          c = this.getNative(); if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
            ...
            d = c.startContainer;
          d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && F[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT) } return a.type = b },
      getRanges: function() {
        var a = B ? function() {
          ...
          return function() {
            ...
            if (d == CKEDITOR.SELECTION_TEXT) return a = new CKEDITOR.dom.range(this.root), d = b(c, !0), a.setStart(new CKEDITOR.dom.node(d.container), d.offset), d = b(c), a.setEnd(new CKEDITOR.dom.node(d.container), d.offset), a.endContainer.getPosition(a.startContainer) & CKEDITOR.POSITION_PRECEDING && a.endOffset <= a.startContainer.getIndex() &&
              a.collapse(), [a];
            if (d == CKEDITOR.SELECTION_ELEMENT) { for (var d = [], e = 0; e < c.length; e++) { for (var f = c.item(e), g = f.parentNode, l = 0, a = new CKEDITOR.dom.range(this.root); l < g.childNodes.length && g.childNodes[l] != f; l++);
      ...
      getSelectedElement: function() { var a = this._.cache; if (void 0 !== a.selectedElement) return a.selectedElement; var b = this,
          c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && F[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ }); return a.selectedElement = c ? new CKEDITOR.dom.element(c) : null },
            ...
            if (h) this.fake(h);
              ...
              if (B) {
                ...
                for (y = 0; y < a.length; y++) {
                  ...
                  try { u.setEnd(h.endContainer.$, h.endOffset) } catch (v) { if (0 <= v.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) h.collapse(1), u.setEnd(h.endContainer.$, h.endOffset);
                    else throw v; }
                  f.addRange(u)
                }
              }
      ...
      removeAllRanges: function() { if (this.getType() != CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[B ? "empty" : "removeAllRanges"]() } catch (b) {}
          this.reset() } }
    }
  })();
  "use strict";
  ...
  (function() {
    ...
    function b(c) {
      ...
      if (c.collapsed) f = J(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
        ...
        var p = c.createBookmark(),
          ...
          u = q,
          t;
        if (!k) { var w = c.getCommonAncestor(),
            k = a(q, w),
            w = a(r, w);
        ...
        for (u.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
          ...
          if (u.equals(r)) u = null, k = !0;
            ...
            if (w && m && CKEDITOR.dtd.$block[z])
              for (var B = u, A = e(B), C = void 0, D = A.length, F = 0, B = D && new CKEDITOR.dom.range(B.getDocument()); F < D; ++F) { var C = A[F],
                  M = CKEDITOR.filter.instances[C.data("cke-filter")]; if (M ? M.check(this) : 1) B.selectNodeContents(C), b.call(this, B) }
            ...
            if (A)
              if (C = u.getParent(), A = h, D = g, F = l, !C || !(C.getDtd() || CKEDITOR.dtd.span)[D] && !F || A.parentRule && !A.parentRule(C)) k = !0;
                ...
                if (t ||
                  z && CKEDITOR.dtd.$removeEmpty[z] && (u.getPosition(r) | Q) != Q || (t = c.clone(), t.setStartBefore(u)), z = u.type, z == CKEDITOR.NODE_TEXT || w || z == CKEDITOR.NODE_ELEMENT && !u.getChildCount()) { for (var z = u, R;
    ...
    function c(a) {
      function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(n.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break;
          p.checkElementRemovable(h, !0) && (e = h) } for (g = 0; g < c.elements.length; g++) { h = c.elements[g]; if (h == c.block || h == c.blockLimit) break;
      ...
      if (a.collapsed) {
        for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, h; g < e.elements.length && (h = e.elements[g]) && h != e.block && h != e.blockLimit; g++)
          if (this.checkElementRemovable(h)) { var k;
      ...
      } else { var n = c.endNode,
          p = this;
        b(); for (e = d; !e.equals(n);) f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? z.call(this, e) : m(e, l(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f }
      a.moveToBookmark(c);
    ...
    function h(a) { var b = a.createBookmark(!0),
        c = a.createIterator();
    ...
    function y(a) { for (var b = l(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var f in b)
        if (f != this.element)
    ...
    CKEDITOR.dom.elementPath = function(b, e) {
      ...
      do
        if (p.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (p.equals(e)) break;
          if (!k && (r = p.getName(),
              "true" == p.getAttribute("contenteditable") ? k = p : !g && d[r] && (g = p), a[r])) { if (r = !g && "div" == r) { a: { r = p.getChildren(); for (var f = 0, B = r.count(); f < B; f++) { var u = r.getItem(f); if (u.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[u.getName()]) { r = !0; break a } }
                r = !1 }
              r = !r }
            r ? g = p : k = p }
        }
  ...
  */
  ...
  (function() {
    function q(b, a, c) { a.type || (a.type = "auto"); if (c && !1 === b.fire("beforePaste", a) || !a.dataValue && a.dataTransfer.isEmpty()) return !1;
    ...
    function z(b) {
      ...
      function c(a) { return { type: a, canUndo: "cut" == a, startDisabled: !0, fakeKeystroke: "cut" == a ? CKEDITOR.CTRL + 88 : CKEDITOR.CTRL + 67, exec: function() { "cut" == this.type && h(); var a; var c = this.type; if (CKEDITOR.env.ie) a = d(c);
      ...
      function w() { if ("paste" == m.mainPasteEvent) return b.fire("beforePaste", { type: "auto", method: "paste" }), !1;
        b.focus();
        f(); var a = b.focusManager;
        a.lock(); if (b.editable().fire(m.mainPasteEvent) && !d("paste")) return a.unlock(), !1;
        a.unlock(); return !0 }
      ...
      function u(a) { var c = { type: "auto", method: "paste", dataTransfer: m.initPasteDataTransfer(a) };
        c.dataTransfer.cacheData(); var d = !1 !== b.fire("beforePaste", c);
      ...
      function t(a) { if (x && a in { paste: 1, cut: 1 }) return CKEDITOR.TRISTATE_DISABLED; if ("paste" == a) return CKEDITOR.TRISTATE_OFF;
        a = b.getSelection(); var c = a.getRanges(); return a.getType() == CKEDITOR.SELECTION_NONE || 1 == c.length && c[0].collapsed ? CKEDITOR.TRISTATE_DISABLED : CKEDITOR.TRISTATE_OFF }
      ...
      (function() {
        function a(c, d, g, e, h) { var k = b.lang.clipboard[d];
          b.addCommand(d, g);
    ...
    function F(b) {
      ...
      b.on("contentDom", function() {
        ...
        function f(a, d, c) { var g = { $: a.data.$, target: a.data.getTarget() };
          d && (g.dragRange = d);
        ...
        d.attachListener(h, "dragover", function(a) { var b = a.data.getTarget();
        ...
        d.attachListener(h, "drop", function(d) { if (!d.data.$.defaultPrevented) { d.data.preventDefault(); var c = d.data.getTarget(); if (!c.isReadOnly() || c.type == CKEDITOR.NODE_ELEMENT && c.is("html")) { var c = a.getRangeAtDropPosition(d, b),
                g = a.dragRange;
    ...
    CKEDITOR.plugins.add("clipboard", {
      ...
      init: function(b) {
        ...
        b.on("paste", function(a) { a.data.dataTransfer || (a.data.dataTransfer = new CKEDITOR.plugins.clipboard.dataTransfer); if (!a.data.dataValue) { var d = a.data.dataTransfer,
              c = d.getData("text/html"); if (c) a.data.dataValue = c, a.data.type = "html";
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      isDropRangeAffectedByDragRange: function(b,
        a) { var c = a.startContainer,
          e = a.endOffset; return b.endContainer.equals(c) && b.endOffset <= e || b.startContainer.getParent().equals(c) && b.startContainer.getIndex() < e || b.endContainer.getParent().equals(c) && b.endContainer.getIndex() < e ? !0 : !1 },
      ...
      getRangeAtDropPosition: function(b, a) {
        ...
        if (document.caretRangeFromPoint) c = a.document.$.caretRangeFromPoint(e, f), d.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), d.collapse(!0);
          ...
          if (document.body.createTextRange) {
            ...
            try {
              for (var h = !1, n = 0; 20 > n && !h; n++) { if (!h) try { c.moveToPoint(e, f - n), h = !0 } catch (p) {}
                if (!h) try { c.moveToPoint(e, f + n), h = !0 } catch (k) {} }
              if (h) { var u = "cke-temp-" + (new Date).getTime();
                c.pasteHTML('\x3cspan id\x3d"' + u + '"\x3e​\x3c/span\x3e'); var r = a.document.getById(u);
      ...
      initPasteDataTransfer: function(b, a) { if (this.isCustomCopyCutSupported) { if (b && b.data && b.data.$) { var c = new this.dataTransfer(b.data.$.clipboardData, a);
            this.copyCutData && c.id == this.copyCutData.id ? (c = this.copyCutData, c.$ = b.data.$.clipboardData) : this.copyCutData = c; return c } return new this.dataTransfer(null, a) } return new this.dataTransfer(CKEDITOR.env.edge && b && b.data.$ && b.data.$.clipboardData || null, a) },
    ...
    CKEDITOR.ui.prototype.addToolbarGroup = function(a, d, g) {
      ...
      if (g) {
        if (g = CKEDITOR.tools.search(c, function(a) {
            return a.name ==
              g
          })) {!g.groups && (g.groups = []); if (d && (d = CKEDITOR.tools.indexOf(g.groups, d), 0 <= d)) { g.groups.splice(d + 1, 0, a); return }
    ...
    createScayt: function(a) {
      ...
      this.loadScaytLibrary(a, function(a) {
        ...
        if (f) {
          ...
          g.subscribe("suggestionListSend", function(a) { for (var b = {}, d = [], c = 0; c < a.suggestionList.length; c++) b["word_" + a.suggestionList[c]] || (b["word_" + a.suggestionList[c]] = a.suggestionList[c], d.push(a.suggestionList[c]));
      ...
      init: function(c) {
        ...
        c.ui.addRichCombo("Styles", {
          ...
          onClick: function(b) { c.focus();
            c.fire("saveSnapshot");
            b = f[b]; var a = c.elementPath(); if (b.group && b.removeStylesFromSameGroup(c)) c.applyStyle(b);
          ...
          refresh: function() { var b = c.elementPath(); if (b) { for (var a in f)
