                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="json_params[email]"
                        placeholder="@lang('Email')"
                        value="{{ $detail->json_params->email ?? old('json_params[email]') }}">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="json_params[phone]" placeholder="@lang('Phone')"
                        value="{{ $detail->json_params->phone ?? old('json_params[phone]') }}">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="json_params[brief][vi]" class="form-control"
                        rows="3">{{ $detail->json_params->brief->vi ?? old('json_params[brief][vi]') }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="json_params[content][vi]" class="form-control"
                        id="content_vi">{{ $detail->json_params->content->vi ?? old('json_params[content][vi]') }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
