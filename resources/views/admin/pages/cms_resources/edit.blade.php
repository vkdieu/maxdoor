                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="json_params[brief][vi]" class="form-control"
                        rows="3">{{ isset($detail->json_params->brief->vi) ? $detail->json_params->brief->vi : old('json_params[brief][vi]') }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="json_params[content][vi]" class="form-control"
                        id="content_vi">{{ isset($detail->json_params->content->vi) ? $detail->json_params->content->vi : old('json_params[content][vi]') }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
