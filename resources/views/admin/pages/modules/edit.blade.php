...
<section class="content">
  ...
  <div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form role="form" action="{{ route(Request::segment(2).'.update', $module->id) }}" method="POST">
      @csrf
      @method('PUT')
      <div class="box-body">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" placeholder="@lang('name')" value="{{ $module->name }}" required>
          </div>

          <div class="form-group">
            <label>@lang('module_code') <small class="text-red">*</small></label>
            <input type="text" class="form-control" name="module_code" placeholder="@lang('module_code')" value="{{ $module->module_code }}"
              required>
          </div>
            ...
            <div class="form-control">
              ...
              <label>
                <input type="radio" name="status" value="deactive" class="ml-15"
                  {{ ($module->status == 'deactive') ? 'checked':'' }}>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="iorder" placeholder="@lang('iorder')" value="{{ $module->iorder }}">
          </div>
