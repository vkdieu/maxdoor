                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" name="start_time"
                        placeholder="@lang('dd/mm/yyyy')" value="{{ old('start_time') }}" required>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control datepicker" name="end_time"
                        placeholder="@lang('dd/mm/yyyy')" value="{{ old('end_time') }}" required>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="duration" min="0"
                        placeholder="@lang('Number of seconds')" value="{{ old('duration') }}">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      @foreach ($pages as $item)
                        <li class="cursor">
                          <input name="json_params[page][]" type="checkbox" value="{{ $item->id }}"
                            class="mr-15 block_item cursor" id="block_content_{{ $item->id }}" autocomplete="off">
