    ...
    <form role="form" action="{{ route(Request::segment(2).'.update', $detail->id) }}" method="POST">
      ...
      <div class="box-body">
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label>
              @lang('widget_code') <small class="text-red">*</small>: 
              <small>
                <i>
            ...
            <input type="text" class="form-control" name="widget_code" placeholder="@lang('widget_code')"
              value="{{ $detail->widget_code }}" required>
          </div>
