@if ($block)
  ...
  @endphp
  <section class="intro-box section-padding sub-bg bord-thin-top">
          ...
          <div class="accordion">
            ...
            @if ($block_childs)
              @foreach ($block_childs as $item)
                ...
                @endphp
                <div class="item wow fadeInUp {{ $loop->index == 0 ? 'active' : '' }} mb-15"
                  ...
                  <div class="accordion-info {{ $loop->index == 0 ? 'active' : '' }} mt-15">
                    <p class="text-light">
                      {!! $brief !!}
                    </p>
                  </div>
