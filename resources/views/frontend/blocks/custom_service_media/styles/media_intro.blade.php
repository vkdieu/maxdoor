@if ($block)
  ...
  <section class="works-header d-flex align-items-end bord-thin-bottom">
    <div class="background bg-img parallaxie" data-background="{{ $image_background }}" data-overlay-dark="3" style="left: 0%;"></div>
    <div class="container-xxl">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="cont mb-80 wow fadeInRight">
            <h6 class="sub-title main-color">@lang('Our services')</h6>
            <h1 class="fw-700 text-uppercase">{{ $brief }}</h1>
          </div>
          <div class="row wow fadeInUp d-none d-md-block" data-wow-delay="1s">
            <div class="col-md-12">
              <div class="item">
