<aside class="page-sidebar content-section">
  ...
  @isset($taxonomys)
    <section class="side-content-section" data-inview-showup="showup-translate-up">
      <h5 class="shift-sm offs-md">@lang('Product Categories')</h5>
  ...
  @isset($recents)
    <section class="side-content-section" data-inview-showup="showup-translate-up">
      ...
      <h5 class="shift-sm offs-md">@lang('Latest products')</h5>
      <div class="items">
          ...
          <div class="shop-side-item">
            ...
            <div class="item-side">
              <div class="item-title">
                <a href="{{ $alias }}" class="content-link text-upper">{{ Str::limit($title, 30) }}</a>
              </div>
  ...
  @isset($recents)
    <section class="side-content-section" data-inview-showup="showup-translate-up">
      ...
      <h5 class="shift-sm offs-md">@lang('Most viewed products')</h5>
      <div class="items">
