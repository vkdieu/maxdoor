<header class="header header-over">
  ...
  <nav class="stick-menu menu-wrap simple line transparent">
    <div class="menu-container menu-row">
      <div class="logo">
        <a href="<?php echo e(route('frontend.home')); ?>"><img src="<?php echo e($web_information->image->logo_header_light ?? ''); ?>"
            alt="Logo"></a>
      </div>
...
<?php /**PATH D:\project\cuacuon\resources\views/frontend/blocks/header/styles/home.blade.php ENDPATH**/ ?>