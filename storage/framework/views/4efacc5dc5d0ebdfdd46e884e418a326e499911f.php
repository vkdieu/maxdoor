      ...
      <form role="form" action="<?php echo e(route(Request::segment(2) . '.update', $admin->id)); ?>" method="POST">
        ...
        <div class="box-body">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label><?php echo app('translator')->get('Password'); ?>
              ...
              <div class="form-control">
                <label>
                  <input type="radio" name="status" value="active"
                    <?php echo e($admin->status == 'active' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\cuacuon\resources\views/admin/pages/admins/edit.blade.php ENDPATH**/ ?>