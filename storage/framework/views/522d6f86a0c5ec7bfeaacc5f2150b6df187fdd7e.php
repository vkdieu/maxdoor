      ...
      <section class="content-section">
        ...
        <?php if(isset($relatedPosts) && count($relatedPosts) > 0): ?>
          <div data-inview-showup="showup-translate-up">
            ...
            <h4 class="text-upper"><?php echo app('translator')->get('Related Services'); ?></h4>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maxdoor\resources\views/frontend/pages/service/detail.blade.php ENDPATH**/ ?>