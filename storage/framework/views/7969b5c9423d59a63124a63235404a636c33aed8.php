                ...
                <div class="item shop-item shop-item-simple" data-inview-showup="showup-scale">
                  ...
                  <div class="item-content shift-md">
                    <div class="item-textes">
                      ...
                      <div class="item-categories"><?php echo e(Str::limit($brief, 50)); ?></div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\cuacuon\resources\views/frontend/pages/product/default.blade.php ENDPATH**/ ?>