<aside class="page-sidebar content-section">
  ...
  <?php if(isset($taxonomys)): ?>
    <section class="side-content-section" data-inview-showup="showup-translate-up">
      <h5 class="shift-sm offs-md"><?php echo app('translator')->get('Product Categories'); ?></h5>
  ...
  <?php if(isset($recents)): ?>
    <section class="side-content-section" data-inview-showup="showup-translate-up">
      ...
      <h5 class="shift-sm offs-md"><?php echo app('translator')->get('Latest products'); ?></h5>
      <div class="items">
          ...
          <div class="shop-side-item">
            ...
            <div class="item-side">
              <div class="item-title">
                <a href="<?php echo e($alias); ?>" class="content-link text-upper"><?php echo e(Str::limit($title, 30)); ?></a>
              </div>
  ...
  <?php if(isset($recents)): ?>
    <section class="side-content-section" data-inview-showup="showup-translate-up">
      ...
      <h5 class="shift-sm offs-md"><?php echo app('translator')->get('Most viewed products'); ?></h5>
      <div class="items">
...
<?php /**PATH C:\xampp\htdocs\maxdoor\resources\views/frontend/components/sidebar/product.blade.php ENDPATH**/ ?>