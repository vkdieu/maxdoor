                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6">
                          ...
                          <input type="text" class="form-control" name="json_params[price_currency]"
                            placeholder="<?php echo app('translator')->get('Price Curreny'); ?>" value="<?php echo e(old('json_params[price_currency]')); ?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\cuacuon\resources\views/admin/pages/cms_services/create.blade.php ENDPATH**/ ?>