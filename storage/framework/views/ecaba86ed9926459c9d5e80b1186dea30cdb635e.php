      ...
      <section class="product-one">
        <div class="container">
          <div class="sec-title text-center">
            <h2 class="sec-title__title"><?php echo e($title); ?></h2>
    ...
    >
      <div class="product-one__single">
        ...
        <div class="product-one__single-content text-center">
          <h2><a href="<?php echo e($alias_category); ?>l"><?php echo e($title); ?></a></h2>
          <p>
            <span><del><?php echo isset($item->json_params->price_old) && $item->json_params->price_old > 0
...
<?php /**PATH C:\xampp\htdocs\maxdoor\resources\views/frontend/blocks/cms_product/styles/default.blade.php ENDPATH**/ ?>