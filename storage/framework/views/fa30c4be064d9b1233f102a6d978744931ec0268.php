    ...
    <div class="row">
      ...
      <div class="col-xl-6 col-lg-12">
        <div class="contact-one__content">
          <div class="sec-title">
            <span class="sec-title__tagline"><?php echo e($brief); ?></span>
            <h2 class="sec-title__title"><?php echo e($content); ?></h2>
          </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\maxdoor\resources\views/frontend/blocks/form/styles/booking.blade.php ENDPATH**/ ?>