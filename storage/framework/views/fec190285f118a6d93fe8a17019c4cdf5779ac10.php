                    ...
                    <div class="col-xl-12">
                        <div class="footer-one--two__contact-box-inner text-center">
                            ...
                            <div class="footer-one--two__contact-box-btn">
                                <a href="#" class="thm-btn"><?php echo app('translator')->get('contac'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s">
                                <div class="footer-widget__column footer-widget__about">
                                    <div class="footer-widget__about-logo">
                                        <a href="<?php echo e(route('frontend.home')); ?>"><img src="<?php echo e($web_information->image->logo_footer ?? ''); ?>"
                                                alt=""></a>
                                    </div>
                                    <p class="footer-widget__about-text"> <?php if(isset($web_information->information->address)): ?>
...
<?php /**PATH C:\xampp\htdocs\maxdoor\resources\views/frontend/blocks/footer/styles/home.blade.php ENDPATH**/ ?>